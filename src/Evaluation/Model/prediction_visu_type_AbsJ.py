...
def main():
    ...
    for i, (theta_arr_i) in enumerate(theta_arr):
        # Create a figure.
        _, ax = plt.subplots()

        # Visualization of relevant structures.
        ax.plot(Polynomial_Cls.t, theta_arr_i, '.-', color='#d0d0d0', linewidth=1.0, markersize = 3.0, 
        ...
        #   Set the y ticks.
        ax.set_yticks(np.arange(np.min(theta_arr_i) - 0.1, np.max(theta_arr_i) + 0.1, 0.1))
        #   Label.
